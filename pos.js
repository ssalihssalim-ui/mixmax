...
async function posFinalizeSale(){
    ...
    // ✅ Récupération de la date/heure personnalisée
    ...
    try{
        ...
        var sd={
            ...
            dateVente: dateVenteTimestamp,          // ← champ date/heure ajouté
...
console.log('⚡ Mixmax Minimarket - POS chargé (final optimisé avec virtualisation + date/heure vente)');
