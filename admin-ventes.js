// ==================== POS-AUDIO.JS v8.1.2 FINAL – COMMANDES VENTES & CRÉDITS ====================
// Mixmax Minimarket – Gestion vocale complète
...
// ==================== PARSER VOCAL – COMMANDES ENRICHIES ====================
function parseVoiceCommand(transcript) {
    ...
    if (currentPage === 'Crédits') {
        ...
        // Filtres, sélection, recherche, etc.
    ...
    if (currentPage === 'Ventes') {
        ...
        if (window.venteSelectionMode) {
            // "tout" (pas encore de sélection multiple, message)
            if (cleaned === 'tout' || cleaned === 'tous' || cleaned.includes('sélectionner tout') || cleaned.includes('tout sélectionner')) {
...
console.log('🎤 Module vocal – complet, ventes & crédits OK');
