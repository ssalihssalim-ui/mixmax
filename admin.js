...
function loadCreditsPage(c) {
    ...
    // Réinitialiser l'état vocal (les variables sont dans pos.js)
    window.creditSelectionMode = false;
    window.creditSelectedIndex = -1;
    creditPaymentAmount = 0; // variable locale
...
function renderCreditsTable() {
    ...
    pageData.forEach(function(d, index) {
        ...
        // Vérifier si cette ligne est sélectionnée (en utilisant window.creditSelectedIndex)
...
// ==================== FONCTIONS VOCALES POUR CRÉDITS (exposées pour pos.js) ====================
// Ces fonctions sont définies dans pos.js, mais on les redéfinit ici pour être sûr
// qu'elles soient disponibles même si pos.js n'est pas encore chargé.
